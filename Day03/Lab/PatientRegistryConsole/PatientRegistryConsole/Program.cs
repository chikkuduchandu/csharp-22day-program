...
namespace PatientRegistryConsole
{
    class Program
    {
        ...
        static List<(string, string,DateTime)> PatientUpdateHistory = new List<(string, string,DateTime)>();
        ...
        static void UpdatePatient()
        {
            ...
            else
            {
                ...
                PatientUpdateHistory.Add((oldName, newName,DateTime.UtcNow));
        ...
        static void DisplayUpdateHistory() {
            ...
            foreach (var h in PatientUpdateHistory)
            {
                Console.WriteLine(h);
            }
        }
